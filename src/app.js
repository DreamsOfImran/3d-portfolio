...
Ammo().then((Ammo) => {
  ...
  //create Ammo.js body to add solid mass to "Imran Basha DevOps Engineer"
  function imranBashaWords(x, y, z) {
    const boxScale = { x: 55, y: 3, z: 2 };
    let quat = { x: 0, y: 0, z: 0, w: 1 };
    let mass = 0; //mass of zero = infinite mass
  ...
  //loads text for Imran Basha Mesh
  function loadImranBashaText() {
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('IMRAN BASHA', {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  //create "FullStack Developer text"
  function loadFullstackText() {
    var text_loader = new THREE.FontLoader();
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('FULLSTACK DEVELOPER', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
  ...
  //create "DevOps Engineer text"
  function loadDevopsText() {
    var text_loader = new THREE.FontLoader();
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('DEVOPS ENGINEER', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
  ...
  function start() {
    ...
    createBillboard(
      ...
      2.5,
      -70,
      billboardTextures.grpcBlogTexture,
      URL.grpcBlog,
      Math.PI * 0.22
    );
    ...
    createBillboard(
      ...
      2.5,
      -78,
      billboardTextures.webauthnBlogTexture,
      URL.webauthnBlog,
      Math.PI * 0.17
    );
    ...
    imranBashaWords(11.2, 1, -20);
    createTextOnPlane(-70, 0.01, -48, inputText.grpcBlogText, 20, 40);
    createTextOnPlane(-42, 0.01, -53, inputText.webauthnBlogText, 20, 40);
    // createTextOnPlane(-14, 0.01, -49, inputText.homeSweetHomeText, 20, 40);

    createBox(-12, 2, -70, 4, 4, 1, boxTexture.facebook, URL.facebook, 0x3b5998, true);

    createBox(-4, 2, -70, 4, 4, 1, boxTexture.twitter, URL.twitter, 0xffffff, true);
    
    createBox(4, 2, -70, 4, 4, 1, boxTexture.instagram, URL.instagram, 0xffffff, true);

    createBox(12, 2, -70, 4, 4, 1, boxTexture.github, URL.github, 0x000000, true);

    createBox(19, 2, -70, 4, 4, 1, boxTexture.medium, URL.medium, 0x000000, true);
    
    createBox(27, 2, -70, 4, 4, 1, boxTexture.linkedIn, URL.linkedIn, 0x0077b5, false);
    
    createBox(35, 2, -70, 4, 4, 1, boxTexture.mail, URL.email, 0x000000, false);
    ...
    floatingLabel(35, 4.5, -70, 'Email');
    floatingLabel(44, 6.5, -70, '  Static \nWebsite');

    allSkillsSection(-50, 0.025, 20, 40, 40, boxTexture.allSkills);
    allSkillsSection(61, 0.025, 13, 30, 60, inputText.timeline);
    // allSkillsSection(8.5, 0.025, 54, 7, 3.5, boxTexture.skrillex);
    allSkillsSection(9, 0.01, 45, 15, 15, boxTexture.aboutMe);
    ...
    simpleText(18, 0.01, -60, touchText, 1.5);
    simpleText(-50, 0.01, -5, 'SKILLS', 3);
    simpleText(-42, 0.01, -30, 'BLOGS', 3);
