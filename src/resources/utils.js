...
export function rotateCamera(ballPosition) {
  ...
  if (
    (ballPosition.position.x < 77 &&
      ...
      ballPosition.position.z < 40) || // Timeline Position
    (ballPosition.position.x < -30 && ballPosition.position.z < -28) || // Blog Position
    (ballPosition.position.x < -25 &&
      ballPosition.position.x > -70 &&
      ballPosition.position.z > -10 &&
      ballPosition.position.z < 40) // Skills Position
  ) {
